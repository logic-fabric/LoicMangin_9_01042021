    ...
    <div class="page-div">
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="card">
            <div class="card-body">
              <form class="form-signin" data-test-id="form-employee">
                ...
                <button class="btn btn-lg btn-primary btn-block" 
                        data-test-id="employee-login-button" style="background-color: #0E5AE5;" type="submit">
                  Se connecter
                </button>
              </form>
            </div>
          ...
          <div class="card">
            <div class="card-body">
              <form class="form-signin" data-testid="form-admin">
                <h2 class="h3 mb-3 font-weight-normal">Administrateur RH</h2>

                <label for="inputEmail">Votre email</label>
                <input type="email" data-testid="admin-email-input" 
                       class="form-control" placeholder="johndoe@email.com" 
                       required autofocus>
                
                <label for="inputPassword">Mot de passe</label>
                <input type="password" data-testid="admin-password-input" 
                       class="form-control" placeholder="******" required>
                
                <button  type="submit" class="btn btn-lg btn-primary btn-block" 
                         data-test-id="admin-login-button" style="background-color: #0E5AE5;">
                  Se connecter
                </button>
              </form>
            </div>
